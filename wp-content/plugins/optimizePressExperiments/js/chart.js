 ...
 *
 * Color object prefixed with "Op" for compatibility with other plugins that were using different libs with the same global name
 */
...
var OpColor = function (obj) {
    if (obj instanceof OpColor) {
        return obj;
    }
    if (!(this instanceof OpColor)) {
        return new OpColor(obj);
    }
...
OpColor.prototype.getValues = function (space) {
    var values = this.values;
    var vals = {};
...
OpColor.prototype.setValues = function (space, vals) {
    var values = this.values;
...
OpColor.prototype.setSpace = function (space, args) {
    var vals = args[0];
...
OpColor.prototype.setChannel = function (space, index, val) {
...
if (typeof window !== 'undefined') {
    window.OpColor = OpColor;
}

module.exports = OpColor;
