...
<div class="product-options-panel">
  <div id="mepr-product-registraion-form-style">
    <span><?php _e('Registration Form Style:', 'memberpress'); ?></span>
    <select id="<?php echo MeprProduct::$signup_form_style_str; ?>" name="<?php echo MeprProduct::$signup_form_style_str; ?>">
      <option value="style1"<?php echo (($product->signup_form_style=='style1')?' selected="selected"':''); ?>><?php _e('DF landing page', 'memberpress'); ?></option>
      <option value="style2"<?php echo (($product->signup_form_style=='style2')?' selected="selected"':''); ?>><?php _e('Chat landing page', 'memberpress'); ?></option>
      <option value="style3"<?php echo (($product->signup_form_style=='style3')?' selected="selected"':''); ?>><?php _e('Pipeline light', 'memberpress'); ?></option>
      <option value="style4"<?php echo (($product->signup_form_style=='style4')?' selected="selected"':''); ?>><?php _e('Pipeline pro', 'memberpress'); ?></option>
      <option value="style5"<?php echo (($product->signup_form_style=='style5')?' selected="selected"':''); ?>><?php _e('Main Sign Up', 'memberpress'); ?></option>
    </select>
  </div>
  ...
  <div id="mepr-product-thank-you-url">
    <span><?php _e('Thank you page url:', 'memberpress'); ?></span>
    <input name="<?php echo MeprProduct::$thank_you_url_str; ?>" id="<?php echo MeprProduct::$thank_you_url_str; ?>" type="text" value="<?php echo $product->thank_you_url; ?>" />
  </div>
