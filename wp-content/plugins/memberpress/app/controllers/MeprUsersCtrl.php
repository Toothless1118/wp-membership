...
class MeprUsersCtrl extends MeprBaseCtrl {
  ...
  public static function save_extra_profile_fields($user_id, $validated=false, $product=false, $is_signup=false) {
    ...
    //dorin's change -> billing address added
    $custom_fields[] = (object)array('field_key' => 'mepr_billing_address', 'field_type' => 'text');
    $custom_fields[] = (object)array('field_key' => 'mepr_city', 'field_type' => 'text');
    $custom_fields[] = (object)array('field_key' => 'mepr_province', 'field_type' => 'text');
    $custom_fields[] = (object)array('field_key' => 'mepr_zip', 'field_type' => 'text');
    $custom_fields[] = (object)array('field_key' => 'mepr_country', 'field_type' => 'text');
