...
class MeprProductsCtrl extends MeprCptCtrl {
  ...
  public static function save_postdata($post_id) {
    ...
    if(!empty($post) && $post->post_type == MeprProduct::$cpt) {
      ...
      $product->signup_form_style = (isset($_mepr_product_signup_form_style))?$_mepr_product_signup_form_style:$product->attrs['signup_form_style']; //dorin's add
      $product->thank_you_url = (isset($_mepr_product_thank_you_url))?$_mepr_product_thank_you_url:$product->attrs['thank_you_url']; //dorin's add
