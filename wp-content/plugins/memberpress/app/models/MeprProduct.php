...
class MeprProduct extends MeprCptModel implements MeprProductInterface {
  ...
  public static $signup_form_style_str          = '_mepr_product_signup_form_style';//dorin's add
  public static $signup_button_text_str         = '_mepr_product_signup_button_text';
  public static $thank_you_url_str              = '_mepr_product_thank_you_url';//dorin's add
  ...
  public function __construct($obj = null) {
    $this->load_cpt(
      ...
      array(
        ...
        'signup_form_style' => 'style1',//dorin's add
        'signup_button_text' => __('Sign Up','memberpress'),
        'thank_you_url' => '/thank-you',//dorin's add
        'limit_cycles' => false,
        'limit_cycles_num' => 2,
    ...
    $this->signup_form_styles = array('style1','style2','style3', 'style4', 'style5');//dorin's add
  ...
  public function validate() {
    ...
    $this->validate_is_in_array($this->signup_form_style, $this->signup_form_styles, 'signup_form_style');//dorin's add
    ...
    $this->validate_not_empty($this->thank_you_url, 'thank_you_url');//dorin's add
  ...
  public function store_meta() {
    ...
    update_post_meta($id, self::$signup_form_style_str, $this->signup_form_style);//dorin's add
    update_post_meta($id, self::$signup_button_text_str, $this->signup_button_text);
    update_post_meta($id, self::$thank_you_url_str, $this->thank_you_url); //dorin's add
