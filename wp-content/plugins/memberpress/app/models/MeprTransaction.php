...
class MeprTransaction extends MeprBaseModel implements MeprProductInterface, MeprTransactionInterface {
  ...
  */
  ...
  public static function create_free_transaction($txn, $df_redirect_url="") {
    $mepr_options = MeprOptions::fetch();
    ...
    if ( $df_redirect_url != "")
      ...
      MeprUtils::wp_redirect("/member-dashboard/?membership=basic-free-plan");
  ...
  public function checkout_url($df_redirect_url = "") { 
    $mepr_options = MeprOptions::fetch();
