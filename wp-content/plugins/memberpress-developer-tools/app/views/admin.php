    ...
    <tr>
      <td class="mepr-settings-table-nav">
        <ul class="mepr-sidebar-nav">
          <li><a data-id="webhooks"><?php _e('Webhooks', 'memberpress-developer-tools'); ?></a></li>
          <li><a data-id="events"><?php _e('Events', 'memberpress-developer-tools'); ?></a></li>
          <li><a data-id="api"><?php _e('REST API', 'memberpress-developer-tools'); ?></a></li>
          <li><a data-id="resources"><?php _e('Other Resources', 'memberpress-developer-tools'); ?></a></li>
        </ul>
      </td>
      <td class="mepr-settings-table-pages">
        <div class="mepr-page" id="webhooks">
          <?php require(MPDT_VIEWS_PATH.'/webhooks.php'); ?>
          <div class="mpdt_spacer"></div>
        </div>
        <div class="mepr-page" id="events">
          <?php require(MPDT_VIEWS_PATH.'/events.php'); ?>
          <div class="mpdt_spacer"></div>
        </div>
        <div class="mepr-page" id="api">
          <?php require(MPDT_VIEWS_PATH.'/api.php'); ?>
          <div class="mpdt_spacer"></div>
        </div>
        <div class="mepr-page" id="resources">
