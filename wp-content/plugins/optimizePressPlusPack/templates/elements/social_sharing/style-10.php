...
<ul id="<?php echo $id; ?>" data-counter="false" class="social-sharing social-sharing-style-10">
    <li class="twitter" data-url="<?php echo $tw_url; ?>"<?php echo (!empty($tw_text) ? ' data-title="'.ucfirst($tw_text).'"' : ''); ?><?php echo ($tw_name != ''?' data-via="'.op_attr($tw_name).'"':'');?> data-lang="<?php echo $tw_lang;?>">
