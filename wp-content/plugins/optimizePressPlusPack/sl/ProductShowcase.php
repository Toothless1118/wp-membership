...
class ProductShowcase implements ElementInterface
{
    protected $atts;
    ...
    public function render()
    {
        return array(
            'javascript' => 'js',
            'markup' => 'PRODUCT SHOWCASE SL!',
            'id' => $this->atts['element_id'];
        );
        return 'PRODUCT SHOWCASE SL!';
        ...
        switch($this->atts['style']) {
            case 1:
                ...
                $markup = '
                <div class="flexslider op-testimonial-slider op_testimonial_slider_' . $this->atts['element_id'] . ' op-testimonial-slider-style-' . $this->atts['style'] . '">
            ...
            case 3:
                ...
                $markup = '
                <div class="flexslider op-testimonial-slider op_testimonial_slider_' . $this->atts['element_id'] . ' op-testimonial-slider-style-' . $this->atts['style'] . '"' . $additional_style . '>
                    <ul class="op-testimonial-slides">
                        %s
                    </ul>
                </div>';
