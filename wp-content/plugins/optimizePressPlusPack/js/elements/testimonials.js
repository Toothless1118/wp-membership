var op_asset_settings = (function($){
    return {
                ...
                testimonials: {
                    ...
                    multirow: {
                        attributes: {
                            image: {
                                title: 'image',
                                showOn: {field:'step_1.style',value:['1','2','3','4','5','6','7','15','16','17','19','20','21','22'],type:'style-selector',idprefix:'op_assets_core_testimonials_'},
                                type: 'media',
                                callback: function(){
                                    var v = $(this).val();
                                    if(v != ''){
                            ...
                            href: {
                                ...
                                showOn: {
                                    ...
                                    idprefix:'op_assets_core_testimonials_'
                                },
                            },
                            button_text: {
                                title: 'button_text',
        ...
        customInsert: function(attrs){
            var str = '',
                font_str = '',
                hasImage = ($.inArray(attrs.style || '',['1','2','3','4','5','6','7','15','16','17','18','19','20','21','22']) > -1),
                hasButtonText = ($.inArray(attrs.style || '',['17']) > -1),
                hasHeaderColor = ($.inArray(attrs.style || '',['18']) > -1),
            ...
            //If this style has an image, make note in the attributes array
            if(hasImage){
                nattrs.push('button_text');
                nl++;
            }
            if(hasHeaderColor){
                nattrs.push('header_color');
                nl++;
            }
        ...
        customSettings: function(attrs,steps){
            var testimonial = attrs.testimonial || [], //Get the testimonial
                ...
                hasImage = ($.inArray(style,['1','2','3','4','5','6','7', '15', '16','17','18','19','20','21','22']) > -1), //Check if this style has an image
                fields = ['name','company','href','content','button_text','header_color'], //Fields to distribute values to
                tmp;

            //If this style has an image, add the image field to the fields array
            ...
            for (var i=0,il=testimonial.length;i<il;i++){
                ...
                $.each(fields,function(t,v){
                    ...
                    var color_container = cur.find('.op-pick-color');
                    var field = 'input';
                    ...
                    if(v == 'content'){
                        ...
                        color_container.val(val || '').css({backgroundColor: val});
