;var op_asset_settings = (function($){
    var fb_styles = ['horizontal','long','style-3','style-4','style-5','style-6','style-7','style-8','style-9','style-10','style-11','style-12','style-13','style-14','style-15','style-16','style-17','style-18','style-19','style-20', 'style-21', 'style-22', 'style-23','style-24','style-25', 'style-26' ,'style-27', 'style-28'],
        tw_styles = ['horizontal','long','style-3','style-4','style-5','style-6','style-7','style-8','style-9','style-10','style-11','style-12','style-13','style-14','style-15','style-16','style-17','style-18','style-19','style-20','style-22','style-23','style-24','style-25', 'style-26', 'style-27', 'style-28'],
        g_styles = ['horizontal','long','style-3','style-4','style-5','style-6','style-7','style-8','style-9','style-10','style-11','style-12','style-13','style-14','style-15','style-16','style-17','style-18','style-19','style-20','style-22','style-23','style-24','style-25',  'style-26', 'style-27', 'style-28'],
        p_styles = ['horizontal','long','style-6','style-22','style-25', 'style-26', 'style-27', 'style-28'],
        su_styles = ['horizontal','long'],
        linkedin_styles = ['horizontal','long','style-6','style-7','style-24','style-25', 'style-26' ,'style-27','style-28'],
        ...
        style_has_background_color = ['style-26', 'style-27'],
        attrs = {
            help_vids: {
                step_1: {
        ...
        attributes: {
            ...
            step_2: {
                ...
                fb_color: {
                    ...
                    default_value: 'light',
                    showOn: {field:'step_1.style',value:['horizontal','long','style-3','style-4','style-5','style-6','style-7','style-8','style-9','style-10','style-11','style-12','style-13','style-14','style-15','style-16','style-17','style-18','style-19','style-20', 'style-21', 'style-22', 'style-23','style-24','style-25']}
                },
                fb_lang: {
                    title: 'language',
                    type: 'select',
                ...
                tw_color: {
                    ...
                    values: {'dark':'dark','light':'light'},
                    default_value: 'light',
                    showOn: {field:'step_1.style',value:['style-25']}
                },
                tw_lang: {
                    title: 'language',
                    type: 'select',
                ...
                background_color: {
                    title: 'social_sharing_background_color',
                    type: 'color',
        ...
        customInsert: function(attrs){
            ...
            for (var url in urls) {
                    if (urls[url] != "" && urlregex.test(urls[url]) === false) {
                        alert("URL you provided for is not in valid format. Please check and correct it.");
                        $("#op_assets_core_social_sharing_" + url).focus();
                        return;
                    }
            }
            ...
            for(var i in attrs){
                if(attrs.hasOwnProperty(i)){
                    if(i == 'style'){
                        ...
                        $('.op_assets_core_social_sharing_background_color input').val(attrs.background_color || '');
