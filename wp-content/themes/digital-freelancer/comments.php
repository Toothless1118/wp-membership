			...
			<?php
				...
				if ( 1 === $comments_number ) {
					printf(
						...
						esc_html_x( '1', 'comments title', 'understrap' ),
						'<span>Comment</span>'
					);
				} else {
					printf( // WPCS: XSS OK.
						...
						'<span class="number">'.number_format_i18n( $comments_number ).'</span><span class="txt">Comments</span>');
				}
			?>
			<a class="somome-share" data-sumome-share-id="b92e1e4c-8f04-46c7-946e-21413f94c9a9"></a>
		</h2><!-- .comments-title -->
